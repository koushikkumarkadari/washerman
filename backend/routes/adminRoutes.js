...
import { getApproved, adminOnly, getAllUsers, getAllOrders, allWasherman } from '../controllers/adminControllers.js';

const adminrouter = express.Router();

adminrouter.get('/washerman', protect, adminOnly, allWasherman);
